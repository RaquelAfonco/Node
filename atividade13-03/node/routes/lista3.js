...
router.post('/q4', function(req, res){
    ...
    const { salarioMinimo, horasTrabalhadas, dependentes, horasQtras } = req.body;
    ...
    const valorHoraQtra = valorHoraTrabalhada * 1.5;
    const salarioHorasQtras = horasQtras * valorHoraQtra;
    const salarioBruto = salarioMes + valorDependentes + salarioHorasQtras;
